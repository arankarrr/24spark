...
- автоматическое обновление подписок каждый час;
- добавление отдельных ссылок `vless://` без подписки;
- измерение задержки и сортировка нод по пингу;
- переключение на доступную ноду с наименьшей задержкой после трёх ошибок связи;
- контроль интернета, DNS, sing-box и TProxy;
- обновление 24spark из GitHub прямо в панели.
...
Используйте кнопку `Обновить из GitHub` в панели или повторно запустите команду
установки. Пользовательская конфигурация и подписки останутся на месте.
